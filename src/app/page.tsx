...
export default function Home() {
  ...
  // Scroll Slide-In Animation Presets
  const scrollReveal = {
  ...
  return (
    <div className="relative w-full bg-black min-h-screen selection:bg-purple-500/30 selection:text-white overflow-x-hidden">
      <SchemaMarkup type="FAQPage" data={faqSchemaData} />

      {/* Embedded Stylesheet for Cyber Grid Movement and Ambient Shifts */}
      <style>{`
        @keyframes drift {
      ...
      {/* ==========================================================
          🌌 LIVE FIXED BACKGROUND MATRIX (Always visible under scroll)
          ========================================================== */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-black">
        {/* Animated Infinite Grid Mesh */}
        <div className="absolute inset-0 cyber-grid-bg opacity-70" />
        
        {/* Slow Moving Dark Nebula Clouds */}
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-purple-900/15 rounded-full filter blur-[140px] mix-blend-screen animate-float-glow" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-indigo-900/15 rounded-full filter blur-[130px] mix-blend-screen animate-float-glow" style={{ animationDelay: '5s' }} />
      </div>

      {/* ==========================================================
          💻 FOREGROUND INTERACTIVE CONTENT DECK
          ========================================================== */}
      <div className="relative z-10 w-full">
        ...
        <motion.section 
          ...
          className="py-24 border-t border-white/[0.04] bg-[#050505]/40 backdrop-blur-sm relative"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-[#111111]/60 backdrop-blur-md rounded-2xl border border-white/10 p-8 relative overflow-hidden space-y-6 shadow-inner hover:border-white/20 transition-colors duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 items-start">
                    <div className="p-2 rounded-lg bg-black/40 border border-white/10 text-white"><Layers className="w-4 h-4" /></div>
                    <div>
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-120px" }}
          variants={scrollReveal}
          className="py-24 bg-transparent border-y border-white/[0.04] relative"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {futureCards.map((card, idx) => {
                ...
                return (
                  <div key={idx} className="bg-[#111111]/40 backdrop-blur-sm border border-white/10 rounded-2xl p-6 transition-all duration-500 hover:border-[#8B5CF6]/50 hover:bg-[#111111]/80 group relative overflow-hidden shadow-xl hover:-translate-y-1">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 rounded-xl bg-black border border-white/10 text-[#8B5CF6] group-hover:text-white transition-colors">
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-120px" }}
          variants={scrollReveal}
          className="py-24 bg-[#050505]/20 backdrop-blur-sm relative"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              {plans.map((plan, idx) => (
                <div 
                  key={idx} 
                  className={`bg-[#111111]/40 backdrop-blur-md border rounded-2xl p-8 relative flex flex-col justify-between transition-all duration-500 hover:shadow-2xl shadow-black ${
                    plan.recommended 
                      ? 'border-[#8B5CF6] shadow-[0_0_40px_rgba(139,92,246,0.15)] lg:scale-105 z-10 bg-[#111111]/70' 
                ...
                >
                  ...
                  <Link 
                    href="/contact" 
                    className={`w-full py-3 rounded-xl text-xs font-semibold text-center transition-all duration-3xl ${
                      plan.recommended 
                        ? 'purple-gradient text-white shadow-md hover:opacity-90' 
                        : 'bg-black/60 text-white border border-white/10 hover:bg-white/5'
                    }`}
                  >
            ...
            <div className="p-6 bg-[#111111]/60 backdrop-blur-md border border-white/10 rounded-xl text-center max-w-xl mx-auto">
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-120px" }}
          variants={scrollReveal}
          className="py-24 bg-transparent border-t border-white/[0.04] relative"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {valueProps.map((vp, idx) => (
                <div key={idx} className="bg-[#111111]/40 backdrop-blur-sm border border-white/5 p-6 rounded-xl space-y-2 hover:border-white/10 transition-colors duration-300 shadow-lg">
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-120px" }}
          variants={scrollReveal}
          className="py-24 bg-[#050505]/40 backdrop-blur-sm relative"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
              {steps.map((st, idx) => (
                <div key={idx} className="bg-[#111111]/40 backdrop-blur-sm border border-white/10 rounded-xl p-6 relative overflow-hidden group hover:border-purple-500/30 transition-all duration-500 shadow-xl">
                  <span className="absolute -top-4 -right-2 text-7xl font-black text-white/5 select-none tracking-tighter group-hover:text-white/10 group-hover:scale-105 transition-all duration-500">
                    {st.step}
                  </span>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => {
                ...
                return (
                  <div key={idx} className="bg-[#111111]/40 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden transition-colors duration-300 shadow-md">
                    <button 
                      onClick={() => setActiveFaq(isSelected ? null : idx)}
                      className="w-full text-left p-5 flex items-center justify-between text-white font-medium text-sm sm:text-base focus:outline-none bg-[#111111]/20 hover:bg-[#111111]/60 transition-colors duration-200"
                    >
                      <span>{faq.q}</span>
                    ...
                    >
                      <p className="p-5 pt-0 text-xs sm:text-sm text-[#A1A1AA] leading-relaxed border-t border-white/5 bg-black/40">
                        {faq.a}
                      </p>
                    </motion.div>
                  </div>
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-120px" }}
          variants={scrollReveal}
          className="py-24 bg-[#050505]/40 backdrop-blur-sm relative border-b border-white/[0.04]"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {insights.map((ins, idx) => (
                <div key={idx} className="bg-[#111111]/40 backdrop-blur-sm border border-white/10 rounded-xl p-6 flex flex-col justify-between group hover:border-[#8B5CF6]/30 transition-all duration-300 shadow-xl hover:-translate-y-0.5">
                  <div className="space-y-4">
        ...
        <motion.section 
          ...
          variants={scrollReveal}
          className="py-24 relative bg-transparent text-center"
        >
